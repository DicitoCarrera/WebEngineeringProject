...
const db = new sqlite3.Database("./database/lessons/lessons.db");

db.serialize(() => {
  db.run(
    "CREATE TABLE lessons (id INTEGER PRIMARY KEY, title TEXT, description TEXT, date TEXT, teacher TEXT, language TEXT, explanation TEXT, content TEXT)",
  );
