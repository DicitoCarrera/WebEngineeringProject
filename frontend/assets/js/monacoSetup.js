document.addEventListener("DOMContentLoaded", function () {
  if (typeof Sk === "undefined") {
    console.error(
      "Skulpt is not defined. Make sure Skulpt is loaded before this script.",
    );
  } else {
  ...
  require(["vs/editor/editor.main"], function () {
    ...
    if (editorContainer) {
      ...
      document.getElementById("run-code").addEventListener(
        "click",
        function () {
          ...
          if (language === "javascript") {
            try {
              ...
              outputElement.innerText = result !== undefined
                ? result
            ...
            if (typeof Sk === "undefined") {
              ...
              Sk.configure({
                output: (text) => outputElement.innerText += text,
              });
