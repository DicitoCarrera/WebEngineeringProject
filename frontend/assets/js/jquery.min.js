    ...
    for (
      e in d = se.support = {},
          ...
          return r != C && 9 === r.nodeType && r.documentElement &&
            (a = (C = r).documentElement,
              ...
              b.find.CLASS = d.getElementsByClassName && function (e, t) {
                if (
                  "undefined" != typeof t.getElementsByClassName && E
              ...
              j = t
                ? function (e, t) {
                  ...
                  return n ||
                    (1 & (n = (e.ownerDocument || e) == (t.ownerDocument || t)
        ...
        se.matchesSelector = function (e, t) {
          if (
            T(e),
              d.matchesSelector && E && !N[t + " "] && (!s || !s.test(t)) &&
              (!v || !v.test(t))
          ) {
            try {
              var n = c.call(e, t);
              if (
                n || d.disconnectedMatch ||
          ...
          reliableTrDimensions: function () {
            ...
            return null == a &&
              (e = E.createElement("table"),
                ...
                a = parseInt(r.height, 10) + parseInt(r.borderTopWidth, 10) +
      ...
      if (
        o =
          ...
          (-1 < d.indexOf(".") && (d = (h = d.split(".")).shift(), h.sort()),
            u = d.indexOf(":") < 0 && "on" + d,
            (e = e[S.expando] ? e : new S.Event(d, "object" == typeof e && e))
              .isTrigger = r ? 2 : 3,
            e.namespace = h.join("."),
  ...
  Mt.href = bt.href,
    S.extend({
      ...
      ajax: function (e, t) {
        ...
        for (
          i in (g = S.event && v.global) && 0 == S.active++ &&
  ...
  S.ajaxSetup({
    ...
    S.ajaxPrefilter("json jsonp", function (e, t, n) {
      var r,
        ...
        o,
        a = !1 !== e.jsonp &&
          (Ut.test(e.url) ? "url" : "string" == typeof e.data &&
            0 ===
      ...
      if (a || "jsonp" === e.dataTypes[0]) {
        return r = e.jsonpCallback = m(e.jsonpCallback)
          ? e.jsonpCallback()
          : e.jsonpCallback,
          a ? e[a] = e[a].replace(Ut, "$1" + r) : !1 !== e.jsonp &&
    ...
    S.fn.load = function (e, t, n) {
      ...
      return -1 < s && (r = ht(e.slice(s)), e = e.slice(0, s)),
        ...
        0 < a.length &&
        S.ajax({ url: e, type: i || "GET", dataType: "html", data: t }).done(
          function (e) {
            o = arguments,
